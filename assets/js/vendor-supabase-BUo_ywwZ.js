const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "assets/js/browser-DhWWBYB2.js",
      "assets/js/vendor-react-CDe1t649.js",
    ])
) => i.map((i) => d[i]);
import { b as e, c as t } from "./vendor-react-CDe1t649.js";
const s = {},
  r = function (e, t, r) {
...
class u {
  constructor(e, { headers: t = {}, customFetch: s, region: i = c.Any } = {}) {
    (this.url = e),
      (this.headers = t),
      (this.region = i),
      (this.fetch = ((e) => {
  ...
  invoke(e, t = {}) {
    ...
    return h(this, void 0, void 0, function* () {
      try {
        const { headers: r, method: i, body: c } = t;
        let l,
          h = {},
          { region: u } = t;
        u || (u = this.region),
...
v.default = class {
  ...
  then(e, t) {
    ...
    let s = (0, this.fetch)(this.url.toString(), {
      ...
      return { error: i, data: n, count: o, status: a, statusText: c };
    });
    return (
        ...
        (s = s.catch((e) => {
          ...
          return {
            error: {
              ...
              details: `${
                null !== (s = null == e ? void 0 : e.stack) && void 0 !== s
                  ? s
                  : ""
              }`,
              hint: "",
...
Object.defineProperty(q, "__esModule", { value: !0 }),
  (q.version = void 0),
  (q.version = "0.0.0-automated"),
  Object.defineProperty(B, "__esModule", { value: !0 }),
  (B.DEFAULT_HEADERS = void 0);
const F = q;
B.DEFAULT_HEADERS = { "X-Client-Info": `postgrest-js/${F.version}` };
var M =
  (t && t.__importDefault) ||
  function (e) {
    return e && e.__esModule ? e : { default: e };
...
f.default = class e {
  constructor(e, { headers: t = {}, schema: s, fetch: r } = {}) {
    (this.url = e),
      (this.headers = Object.assign(Object.assign({}, K.DEFAULT_HEADERS), t)),
      (this.schemaName = s),
      (this.fetch = r);
  }
  from(e) {
    const t = new URL(`${this.url}/${e}`);
    return new J.default(t, {
...
const V = H(p);
d.PostgrestQueryBuilder = V.default;
const W = H(g);
d.PostgrestFilterBuilder = W.default;
const Y = H(y);
...
var Z = (d.default = {
  PostgrestClient: G.default,
  PostgrestQueryBuilder: V.default,
  PostgrestFilterBuilder: W.default,
  PostgrestTransformBuilder: Y.default,
  PostgrestBuilder: Q.default,
  PostgrestError: X.default,
});
const {
    PostgrestClient: ee,
    PostgrestQueryBuilder: te,
    PostgrestFilterBuilder: se,
    PostgrestTransformBuilder: re,
    PostgrestBuilder: ie,
    PostgrestError: ne,
  } = Z,
  oe = { "X-Client-Info": "realtime-js/2.11.2" };
var ae, ce, le, he, ue, de, fe, pe, ge, ye, ve;
((ce = ae || (ae = {}))[(ce.connecting = 0)] = "connecting"),
  (ce[(ce.open = 1)] = "open"),
  (ce[(ce.closing = 2)] = "closing"),
  (ce[(ce.closed = 3)] = "closed"),
  ((he = le || (le = {})).closed = "closed"),
  (he.errored = "errored"),
  (he.joined = "joined"),
  (he.joining = "joining"),
  (he.leaving = "leaving"),
  ((de = ue || (ue = {})).close = "phx_close"),
  (de.error = "phx_error"),
  (de.join = "phx_join"),
  (de.reply = "phx_reply"),
  (de.leave = "phx_leave"),
  (de.access_token = "access_token"),
  ((fe || (fe = {})).websocket = "websocket"),
  ((ge = pe || (pe = {})).Connecting = "connecting"),
  (ge.Open = "open"),
  (ge.Closing = "closing"),
  (ge.Closed = "closed");
class me {
...
((ve = ye || (ye = {})).abstime = "abstime"),
  (ve.bool = "bool"),
  (ve.date = "date"),
  (ve.daterange = "daterange"),
  (ve.float4 = "float4"),
  (ve.float8 = "float8"),
  (ve.int2 = "int2"),
  (ve.int4 = "int4"),
  (ve.int4range = "int4range"),
  (ve.int8 = "int8"),
  (ve.int8range = "int8range"),
  (ve.json = "json"),
  (ve.jsonb = "jsonb"),
  (ve.money = "money"),
  (ve.numeric = "numeric"),
  ...
  (ve.timestamptz = "timestamptz"),
  (ve.timetz = "timetz"),
  (ve.tsrange = "tsrange"),
  (ve.tstzrange = "tstzrange");
const we = (e, t, s = {}) => {
    var r;
    const i = null !== (r = s.skipTypes) && void 0 !== r ? r : [];
    return Object.keys(t).reduce((s, r) => ((s[r] = be(r, e, t, i)), s), {});
  },
  be = (e, t, s, r) => {
    const i = t.find((t) => t.name === e),
      n = null == i ? void 0 : i.type,
      o = s[e];
    return n && !r.includes(n) ? ke(n, o) : Te(o);
  },
  ke = (e, t) => {
    if ("_" === e.charAt(0)) {
  ...
  Oe = (e) => ("string" == typeof e ? e.replace(" ", "T") : e),
  $e = (e) => {
    let t = e;
    return (
  ...
  constructor(e, t) {
    ...
    this.channel._on(s.state, {}, (e) => {
      ...
      (this.joinRef = this.channel._joinRef()),
        (this.state = Be.syncState(this.state, e, t, s)),
        this.pendingDiffs.forEach((e) => {
          this.state = Be.syncDiff(this.state, e, t, s);
        }),
        (this.pendingDiffs = []),
        r();
    }),
      this.channel._on(s.diff, {}, (e) => {
        ...
        this.inPendingSyncState()
          ...
          : ((this.state = Be.syncDiff(this.state, e, t, s)), r());
      }),
      this.onJoin((e, t, s) => {
...
((Ie = xe || (xe = {})).ALL = "*"),
  ...
  (Ie.UPDATE = "UPDATE"),
  (Ie.DELETE = "DELETE"),
  ((Ue = Le || (Le = {})).BROADCAST = "broadcast"),
  (Ue.PRESENCE = "presence"),
  (Ue.POSTGRES_CHANGES = "postgres_changes"),
  (Ue.SYSTEM = "system"),
  ((Ne = De || (De = {})).SUBSCRIBED = "SUBSCRIBED"),
  (Ne.TIMED_OUT = "TIMED_OUT"),
  (Ne.CLOSED = "CLOSED"),
  (Ne.CHANNEL_ERROR = "CHANNEL_ERROR");
class qe {
  constructor(e, t = { config: {} }, s) {
    (this.topic = e),
      ...
      (this.joinPush = new Ae(this, ue.join, this.params, this.timeout)),
      (this.rejoinTimer = new _e(
      ...
      this._on(ue.reply, {}, (e, t) => {
        this._trigger(this._replyEventName(t), e);
      }),
      (this.presence = new Be(this)),
      (this.broadcastEndpointURL = $e(this.socket.endPoint) + "/api/broadcast"),
  ...
  subscribe(e, t = this.timeout) {
      ...
      throw "tried to subscribe multiple times. 'subscribe' can only be called a single time per channel instance";
    {
      ...
      this._onError((t) => (null == e ? void 0 : e(De.CHANNEL_ERROR, t))),
        this._onClose(() => (null == e ? void 0 : e(De.CLOSED)));
      const a = {},
        c = {
          broadcast: i,
          presence: n,
          ...
          .receive("ok", async ({ postgres_changes: t }) => {
            ...
            if ((this.socket.setAuth(), void 0 !== t)) {
              ...
              return (
                ...
                void (e && e(De.SUBSCRIBED))
              );
            }
            null == e || e(De.SUBSCRIBED);
          })
          .receive("error", (t) => {
            null == e ||
              e(
  ...
  unsubscribe(e = this.timeout) {
    ...
    const t = () => {
      this.socket.log("channel", `leave ${this.topic}`),
        this._trigger(ue.close, "leave", this._joinRef());
    };
    return (
      this.rejoinTimer.reset(),
      this.joinPush.destroy(),
      new Promise((s) => {
        const r = new Ae(this, ue.leave, {}, e);
        r
          .receive("ok", () => {
            t(), s("ok");
          })
  ...
  _trigger(e, t, s) {
    ...
    const n = e.toLocaleLowerCase(),
      { close: o, error: a, leave: c, join: l } = ue;
    if (s && [o, a, c, l].indexOf(n) >= 0 && s !== this._joinRef()) return;
      ...
      (this.bindings[s] = this.bindings[s].filter((e) => {
        ...
        return !(
          (null === (r = e.type) || void 0 === r
            ? void 0
            : r.toLocaleLowerCase()) === s && qe.isEqual(e.filter, t)
        );
      })),
      this
    );
...
class Je {
  constructor(e, t) {
    ...
    if (
      ...
      (this.reconnectTimer = new _e(async () => {
  ...
  connect() {
    if (!this.conn)
      if (this.transport)
        ...
        (this.conn = new ze(this.endpointURL(), void 0, {
          close: () => {
            this.conn = null;
          },
        })),
          r(async () => {
            const { default: e } = await import("./browser-DhWWBYB2.js").then(
              (e) => e.b
            );
            return { default: e };
  ...
  channel(e, t = { config: {} }) {
    const s = new qe(`realtime:${e}`, t, this);
  ...
  async setAuth(e = null) {
    ...
    if (t) {
      ...
      if (e && e.exp) {
        if (!(Math.floor(Date.now() / 1e3) - e.exp < 0))
          return (
            this.log(
              "auth",
      ...
      (this.accessTokenValue = t),
        this.channels.forEach((e) => {
          t && e.updateJoinPayload({ access_token: t }),
            e.joinedOnce &&
              e._isJoined() &&
              e._push(ue.access_token, { access_token: t });
        });
    }
  }
  async sendHeartbeat() {
...
const Ye = (e) => {
    ...
    return (
      (t =
        ...
        ("undefined" == typeof fetch
          ? (...e) =>
              r(async () => {
                const { default: e } = await Promise.resolve().then(() => S);
                return { default: e };
              }, void 0).then(({ default: t }) => t(...e))
          : fetch)),
      (...e) => t(...e)
  ...
  Qe = (e) => {
    if (Array.isArray(e)) return e.map((e) => Qe(e));
...
const Ze = (e) =>
  ...
  et = (e, t, s) =>
    Xe(void 0, void 0, void 0, function* () {
      const i = yield We(void 0, void 0, void 0, function* () {
        return "undefined" == typeof Response
          ? (yield r(() => Promise.resolve().then(() => S), void 0)).Response
          : Response;
      });
...
function st(e, t, s, r) {
  return Xe(this, void 0, void 0, function* () {
    return tt(e, "GET", t, s, r);
  });
}
function rt(e, t, s, r, i) {
  return Xe(this, void 0, void 0, function* () {
    return tt(e, "POST", t, r, i, s);
  });
}
function it(e, t, s, r, i) {
  return Xe(this, void 0, void 0, function* () {
    return tt(e, "DELETE", t, r, i, s);
  });
}
var nt = function (e, t, s, r) {
  return new (s || (s = Promise))(function (i, n) {
    function o(e) {
      try {
        c(r.next(e));
...
const ot = { limit: 100, offset: 0, sortBy: { column: "name", order: "asc" } },
  at = {
    cacheControl: "3600",
...
class ct {
  ...
  uploadOrUpdate(e, t, s, r) {
    return nt(this, void 0, void 0, function* () {
      try {
        let i;
        const n = Object.assign(Object.assign({}, at), r);
        let o = Object.assign(
          Object.assign({}, this.headers),
        ...
        const c = this._removeEmptyFolders(t),
          ...
          u = yield h.json();
        if (h.ok)
          return { data: { path: c, id: u.Id, fullPath: u.Key }, error: null };
  ...
  uploadToSignedUrl(e, t, s, r) {
    return nt(this, void 0, void 0, function* () {
      ...
      try {
        let e;
        const t = Object.assign({ upsert: at.upsert }, r),
  ...
  createSignedUploadUrl(e, t) {
    return nt(this, void 0, void 0, function* () {
      try {
        ...
        if (!o) throw new Ke("No token returned by API");
        return {
    ...
    return nt(this, void 0, void 0, function* () {
      ...
      try {
        const t = this._getFinalPath(e),
          r = yield st(this.fetch, `${this.url}/${s}/${t}${i}`, {
            headers: this.headers,
            noResolveJson: !0,
          });
  ...
  info(e) {
    return nt(this, void 0, void 0, function* () {
      const t = this._getFinalPath(e);
      try {
        const e = yield st(this.fetch, `${this.url}/object/info/${t}`, {
          headers: this.headers,
        });
        return { data: Qe(e), error: null };
      } catch (s) {
        if (He(s)) return { data: null, error: s };
        throw s;
      }
  ...
  list(e, t, s) {
    return nt(this, void 0, void 0, function* () {
      try {
        const r = Object.assign(Object.assign(Object.assign({}, ot), t), {
          prefix: e || "",
        });
        return {
          data: yield rt(
...
const lt = { "X-Client-Info": "storage-js/2.7.1" };
var ht = function (e, t, s, r) {
  return new (s || (s = Promise))(function (i, n) {
    function o(e) {
      try {
        c(r.next(e));
...
class dt extends ut {
  ...
  from(e) {
    return new ct(this.url, this.headers, e, this.fetch);
  }
}
let ft = "";
ft =
  "undefined" != typeof Deno
    ...
    ? "react-native"
    : "node";
const pt = { headers: { "X-Client-Info": `supabase-js-${ft}/2.49.4` } },
  gt = { schema: "public" },
  yt = {
    autoRefreshToken: !0,
    persistSession: !0,
...
const _t = (e, t, s) => {
  const r = ((e) => {
      let t;
      return (
        (t = e || ("undefined" == typeof fetch ? w : fetch)), (...e) => t(...e)
      );
    })(s),
    i = "undefined" == typeof Headers ? b : Headers;
  return (s, n) =>
    mt(void 0, void 0, void 0, function* () {
      ...
      return (
        ...
        r(s, Object.assign(Object.assign({}, n), { headers: c }))
      );
    });
};
var wt = function (e, t, s, r) {
  return new (s || (s = Promise))(function (i, n) {
    function o(e) {
      try {
        c(r.next(e));
...
const bt = "2.69.1",
  kt = 3e4,
  Tt = 9e4,
  St = { "X-Client-Info": `gotrue-js/${bt}` },
  Et = "X-Supabase-Api-Version",
  jt = { timestamp: Date.parse("2024-01-01T00:00:00.0Z"), name: "2024-01-01" },
  Pt = /^([a-z0-9_-]{4})*($|[a-z0-9_-]{3}$|[a-z0-9_-]{2}$)$/i;
...
function Bt(e) {
  return $t(e) && "AuthRetryableFetchError" === e.name;
}
class qt extends Ct {
  constructor(e, t, s) {
...
const Mt =
  ...
  zt = (() => {
    ...
    for (let t = 0; t < Jt.length; t += 1) e[Jt[t].charCodeAt(0)] = -2;
    for (let t = 0; t < Mt.length; t += 1) e[Mt[t].charCodeAt(0)] = t;
    return e;
  })();
function Kt(e, t, s) {
  const r = zt[e];
...
function Ht(e) {
  ...
  for (let o = 0; o < e.length; o += 1) Kt(e.charCodeAt(o), i, n);
  return t.join("");
}
function Gt(e, t) {
  if (!(e <= 127)) {
    ...
    if (e <= 65535)
      return (
        t(224 | (e >> 12)), t(128 | ((e >> 6) & 63)), void t(128 | (63 & e))
      );
    if (e <= 1114111)
      return (
        t(240 | (e >> 18)),
...
function Vt(e) {
  ...
  for (let i = 0; i < e.length; i += 1) Kt(e.charCodeAt(i), s, r);
...
const Yt = () => "undefined" != typeof window && "undefined" != typeof document,
  Qt = { tested: !1, writable: !1 },
  Xt = () => {
    if (!Yt()) return !1;
    try {
    ...
    if (Qt.tested) return Qt.writable;
...
function is(e) {
  const t = e.split(".");
  if (3 !== t.length) throw new Ft("Invalid JWT structure");
  for (let s = 0; s < t.length; s++)
    if (!Pt.test(t[s])) throw new Ft("JWT not in base64url format");
  return {
    header: JSON.parse(Ht(t[0])),
    payload: JSON.parse(Ht(t[1])),
    signature: Vt(t[2]),
...
async function as(e, t, s = !1) {
  ...
  let i = r;
  s && (i += "/PASSWORD_RECOVERY"), await es(e, `${t}-code-verifier`, i);
  const n = await os(r);
  return [n, r === n ? "plain" : "s256"];
}
rs.promiseConstructor = Promise;
const cs = /^2[0-9]{3}-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[0-1])$/i;
const ls = (e) =>
    e.msg || e.message || e.error_description || e.error || JSON.stringify(e),
  hs = [502, 503, 504];
async function us(e) {
  ...
  if (
    ...
    throw new Nt(ls(e), 0);
  if (hs.includes(e.status)) throw new Nt(ls(e), e.status);
  let r, i;
  try {
    r = await e.json();
  } catch (o) {
  ...
  const n = (function (e) {
    const t = e.headers.get(Et);
    if (!t) return null;
    if (!t.match(cs)) return null;
    try {
  ...
  if (
    ...
    if ("session_not_found" === i) throw new xt();
  } else if (
    "object" == typeof r &&
    r &&
    ...
    throw new qt(ls(r), e.status, r.weak_password.reasons);
  throw new At(ls(r), e.status || 500, i);
}
async function ds(e, t, s, r) {
  var i;
...
class _s {
  ...
  async signOut(e, t = "global") {
    try {
      return (
        await ds(this.fetch, "POST", `${this.url}/logout?scope=${t}`, {
          headers: this.headers,
          jwt: e,
          noResolveJson: !0,
        }),
  ...
  async inviteUserByEmail(e, t = {}) {
    try {
      return await ds(this.fetch, "POST", `${this.url}/invite`, {
  ...
  async generateLink(e) {
    try {
      ...
      return (
        ...
        await ds(this.fetch, "POST", `${this.url}/admin/generate_link`, {
          body: r,
          headers: this.headers,
          xform: vs,
  ...
  async createUser(e) {
    try {
      return await ds(this.fetch, "POST", `${this.url}/admin/users`, {
        body: e,
        headers: this.headers,
        xform: gs,
      });
  ...
  async listUsers(e) {
    ...
    try {
      const c = { nextPage: null, lastPage: 0, total: 0 },
        l = await ds(this.fetch, "GET", `${this.url}/admin/users`, {
          headers: this.headers,
          noResolveJson: !0,
          query: {
            page:
      ...
      const h = await l.json(),
        u =
          null !== (n = l.headers.get("x-total-count")) && void 0 !== n ? n : 0,
        d =
          null !==
            (a =
      ...
      if ($t(c)) return { data: { users: [] }, error: c };
      throw c;
    }
  }
  async getUserById(e) {
    try {
      return await ds(this.fetch, "GET", `${this.url}/admin/users/${e}`, {
        headers: this.headers,
        xform: gs,
      });
    } catch (t) {
  ...
  async updateUserById(e, t) {
    try {
      return await ds(this.fetch, "PUT", `${this.url}/admin/users/${e}`, {
        body: t,
        headers: this.headers,
        xform: gs,
      });
  ...
  async deleteUser(e, t = !1) {
    try {
      return await ds(this.fetch, "DELETE", `${this.url}/admin/users/${e}`, {
        headers: this.headers,
...
const ws = {
  getItem: (e) => (Xt() ? globalThis.localStorage.getItem(e) : null),
  setItem: (e, t) => {
    Xt() && globalThis.localStorage.setItem(e, t);
  },
  removeItem: (e) => {
    Xt() && globalThis.localStorage.removeItem(e);
  },
};
function bs(e = {}) {
  return {
...
class Os {
  constructor(e) {
    ...
    if (
      ...
      (this.admin = new _s({ url: r.url, headers: r.headers, fetch: r.fetch })),
      (this.url = r.url),
      (this.headers = r.headers),
      (this.fetch = Zt(r.fetch)),
      (this.lock = r.lock || Ps),
      ...
      this.persistSession
        ? r.storage
          ...
          : Xt()
          ? (this.storage = ws)
          : ((this.memoryStorage = {}), (this.storage = bs(this.memoryStorage)))
        : ((this.memoryStorage = {}), (this.storage = bs(this.memoryStorage))),
      Yt() &&
  ...
  async _initialize() {
    ...
    try {
      ...
      if (
        ...
        Yt() && this.detectSessionInUrl && "none" !== s)
      ) {
        ...
        if (i) {
          if (
            ...
            (function (e) {
              return $t(e) && "AuthImplicitGrantRedirectError" === e.name;
            })(i))
          ) {
            const t =
      ...
      return $t(t)
        ? { error: t }
        : { error: new Rt("Unexpected error during initialization", t) };
    } finally {
  ...
  async signInAnonymously(e) {
    var t, s, r;
    try {
      const i = await ds(this.fetch, "POST", `${this.url}/signup`, {
          headers: this.headers,
          body: {
            data:
              null !==
    ...
    try {
      ...
      if ("email" in e) {
        ...
        let o = null,
          a = null;
        "pkce" === this.flowType &&
          ([o, a] = await as(this.storage, this.storageKey)),
          (i = await ds(this.fetch, "POST", `${this.url}/signup`, {
            headers: this.headers,
  ...
  async _exchangeCodeForSession(e) {
    const t = await ts(this.storage, `${this.storageKey}-code-verifier`),
      [s, r] = (null != t ? t : "").split("/");
    try {
      const { data: t, error: i } = await ds(
        this.fetch,
        "POST",
      ...
      if ((await ss(this.storage, `${this.storageKey}-code-verifier`), i))
        throw i;
    ...
    try {
      if ("email" in e) {
        ...
        let n = null,
          o = null;
        "pkce" === this.flowType &&
          ([n, o] = await as(this.storage, this.storageKey));
        const { error: a } = await ds(this.fetch, "POST", `${this.url}/otp`, {
          headers: this.headers,
          body: {
            email: r,
            data:
      ...
      if ($t(o)) return { data: { user: null, session: null }, error: o };
      throw o;
    }
  }
  async verifyOtp(e) {
    ...
    try {
      ...
      if ($t(r)) return { data: { user: null, session: null }, error: r };
      throw r;
    }
  }
  async signInWithSSO(e) {
    ...
    try {
      ...
      return (
        "pkce" === this.flowType &&
          ([i, n] = await as(this.storage, this.storageKey)),
        await ds(this.fetch, "POST", `${this.url}/sso`, {
          body: Object.assign(
            Object.assign(
              Object.assign(
                Object.assign(
    ...
    try {
      ...
      if ("email" in e) {
        const { email: s, type: r, options: i } = e,
          { error: n } = await ds(this.fetch, "POST", t, {
            headers: this.headers,
            body: {
              email: s,
              type: r,
      ...
      if ("phone" in e) {
        const { phone: s, type: r, options: i } = e,
          { data: n, error: o } = await ds(this.fetch, "POST", t, {
            headers: this.headers,
            body: {
              phone: s,
              type: r,
  ...
  async __loadSession() {
    ...
    try {
      let e = null;
      const t = await ts(this.storage, this.storageKey);
      if (
      ...
      const s = !!e.expires_at && 1e3 * e.expires_at - Date.now() < Tt;
      if (
        (this._debug(
          "#__loadSession()",
  ...
  async _getUser(e) {
    try {
      return e
        ? await ds(this.fetch, "GET", `${this.url}/user`, {
            headers: this.headers,
            jwt: e,
            xform: gs,
          })
        : await this._useSession(async (e) => {
            ...
            return (null === (t = i.session) || void 0 === t
              ...
              : { data: { user: null }, error: new xt() };
          });
    } catch (t) {
      if ($t(t))
        return (
          (function (e) {
            return $t(e) && "AuthSessionMissingError" === e.name;
          })(t) &&
            (await this._removeSession(),
  ...
  async _setSession(e) {
    try {
      if (!e.access_token || !e.refresh_token) throw new xt();
      const t = Date.now() / 1e3;
      let s = t,
        r = !0,
        i = null;
      const { payload: n } = is(e.access_token);
  ...
  async _refreshSession(e) {
    try {
      return await this._useSession(async (t) => {
        ...
        if (!(null == e ? void 0 : e.refresh_token)) throw new xt();
        const { session: r, error: i } = await this._callRefreshToken(
          e.refresh_token
        );
        return i
  ...
  async _getSessionFromURL(e, t) {
    try {
      if (!Yt()) throw new Ut("No browser detected.");
      ...
      switch (t) {
        case "implicit":
          if ("pkce" === this.flowType)
            throw new Dt("Not a valid PKCE flow url.");
          break;
        case "pkce":
          if ("implicit" === this.flowType)
            throw new Ut("Not a valid implicit grant flow url.");
      }
      if ("pkce" === t) {
        if (
          (this._debug("#_initialize()", "begin", "is PKCE flow", !0), !e.code)
        )
          throw new Dt("No code detected.");
      ...
      if (!(i && o && n && c)) throw new Ut("No session defined in URL");
      ...
      return (
        ...
        { data: { session: p, redirectType: e.type }, error: null }
      );
    } catch (s) {
      if ($t(s))
    ...
    return await this._useSession(async (t) => {
      ...
      if (n) {
        ...
        if (
          t &&
          (!(function (e) {
            return $t(e) && "AuthApiError" === e.name;
          })(t) ||
  ...
  async resetPasswordForEmail(e, t = {}) {
    let s = null,
      r = null;
    "pkce" === this.flowType &&
      ([s, r] = await as(this.storage, this.storageKey, !0));
    try {
      return await ds(this.fetch, "POST", `${this.url}/recover`, {
        body: {
          email: e,
          code_challenge: s,
  ...
  async linkIdentity(e) {
    ...
    try {
      const { data: s, error: r } = await this._useSession(async (t) => {
        ...
        return await ds(this.fetch, "GET", l, {
          headers: this.headers,
          jwt:
            null !==
              (o =
    ...
    try {
      ...
      return await ((s = async (s) => (
        ...
        await ds(
          ...
          { body: { refresh_token: e }, headers: this.headers, xform: fs }
        )
      )),
      (r = (e, t) => {
        const s = 200 * Math.pow(2, e);
        return t && Bt(t) && Date.now() + s - i < kt;
      }),
      new Promise((e, t) => {
        (async () => {
          for (let n = 0; n < 1 / 0; n++)
  ...
  async _handleProviderSignIn(e, t) {
    ...
    return (
      ...
      Yt() && !t.skipBrowserRedirect && window.location.assign(s),
  ...
  async _recoverAndRefresh() {
    ...
    this._debug(t, "begin");
    try {
      const s = await ts(this.storage, this.storageKey);
      ...
      const r =
        1e3 * (null !== (e = s.expires_at) && void 0 !== e ? e : 1 / 0) -
          Date.now() <
        Tt;
      if (
        (this._debug(
      ...
      return void this._debug(t, "error", s);
    } finally {
      this._debug(t, "end");
    }
  }
  ...
  async _saveSession(e) {
    this._debug("#_saveSession()", e),
      ...
      await es(this.storage, this.storageKey, e);
  }
        ...
        try {
          ...
          try {
            return await this._useSession(async (e) => {
              ...
              const r = Math.floor((1e3 * s.expires_at - t) / kt);
              this._debug(
                "#_autoRefreshTokenTick()",
  ...
  async _getUrlForProvider(e, t, s) {
    ...
    if (
      ...
      const [e, t] = await as(this.storage, this.storageKey),
    ...
    return this._acquireLock(
      ...
      async () =>
        await this._useSession(async (e) => {
          ...
          const { payload: n } = is(r.access_token);
          let o = null;
          n.aal && (o = n.aal);
          let a = o;
          (null !==
  ...
  async fetchJwk(e, t = { keys: [] }) {
    ...
    if (
      ...
      s && this.jwks_cached_at + 6e5 > Date.now())
    )
      return s;
    const { data: r, error: i } = await ds(
      this.fetch,
      "GET",
    ...
    if (i) throw i;
    if (!r.keys || 0 === r.keys.length) throw new Ft("JWKS is empty");
    if (
      ((this.jwks = r),
      ...
      throw new Ft("No matching signing key found in JWKS");
    return s;
  }
  async getClaims(e, t = { keys: [] }) {
    try {
      ...
      const c = (function (e) {
        ...
        l = await this.fetchJwk(r.kid, t),
        h = await crypto.subtle.importKey("jwk", l, c, !0, ["verify"]);
      if (!(await crypto.subtle.verify(c, h, n, Wt(`${o}.${a}`))))
  ...
  constructor(e, t, s) {
    ...
    const a = `sb-${new URL(this.authUrl).hostname.split(".")[0]}-auth-token`,
      c = (function (e, t) {
        ...
        db: gt,
        realtime: vt,
        auth: Object.assign(Object.assign({}, yt), { storageKey: a }),
        global: pt,
      });
    (this.storageKey =
      null !== (r = c.auth.storageKey) && void 0 !== r ? r : ""),
      (this.headers = null !== (i = c.global.headers) && void 0 !== i ? i : {}),
      c.accessToken
        ...
        : (this.auth = this._initSupabaseAuthClient(
            null !== (n = c.auth) && void 0 !== n ? n : {},
            this.headers,
            c.global.fetch
          )),
      (this.fetch = _t(t, this._getAccessToken.bind(this), c.global.fetch)),
...
const xs = (e, t, s) => new Cs(e, t, s);
export { r as _, xs as c };
//# sourceMappingURL=vendor-supabase-BUo_ywwZ.js.map
